...
// esto deberia estar en un paquete snake
...
// gameState lo podriamos usar como un mensaje JSON de Servidor a Cliente.Habria que pensarlo un poco mas para
// que el mensaje tenga solo la informacion que sirve
var (
	boardWidth  = 20
	boardHeight = 20
	gameState   = struct {
...
// Toda esta logica hasta la funcion MoveSnake() la deberia tener Snake.
...
// Casi seguro que estas funciones forman parte de este archivo
func startGameLoop() {
